(function($) {
	$.fn.grid = function(x, y, p1_color, p2_color, name_p1, name_p2, turn) {
		...
		function displayScore(score_a, score_b) {
			/* Affichage de la couleur des joueurs <a class="waves-effect waves-light btn">button</a>*/
			$("#score").append('<a class="waves-effect waves-light btn">Score : ' + score_a + ' - ' + score_b + '</a><br><br>')
		}

		function displayButton() {
			/* Affichage des boutons */
			$("#score").append('<a class="waves-effect waves-light btn" id="reset_game">Nouvelle Partie</a>').append("<input type='submit' class='waves-effect waves-light btn' value='Reset score' id='reset_button'>").append("<button id='cancel'  class='waves-effect waves-light btn'>Annuler</button>")
		}
